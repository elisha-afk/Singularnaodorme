...
function ReportPage() {
  ...
  function validate() {
    ...
    if (!agreed) next.terms = 'Você precisa aceitar os termos para enviar a denúncia.'
    setErrors(next)
